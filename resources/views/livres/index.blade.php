...
<head>
    ...
    <style>
        ...
        .category-img, .rayon-img {
            height: 300px; /* Définir une hauteur réduite */
            object-fit: cover;
        }
    </style>
</head>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="https://i.pinimg.com/564x/18/75/62/187562fa2b5fa072ca1591e3eaf2f4fc.jpg" class="d-block w-100 carousel-img" alt="Slide 2">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img src="https://i.pinimg.com/564x/44/69/68/4469683a4904951a3661b64c109c4ba2.jpg" class="d-block w-100 carousel-img" alt="Slide 3">
            <div class="carousel-caption d-none d-md-block">
        ...
        @foreach($categories as $categorie)
            <div class="col">
                <div class="card text-bg-dark h-100">
                    <img src="{{ $categorie->image_url }}https://i.pinimg.com/736x/f5/ca/8e/f5ca8ea3db06fcef3b9cdb5fb47a58d9.jpg" class="card-img category-img" alt="{{ $categorie->libelle }}">
...
<section id="rayons" class="rayon mt-5">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        @foreach($rayons as $rayon)
            <div class="col">
                <div class="card text-bg-dark h-100">
                    <img src="{{ $rayon->image_url }}https://i.pinimg.com/564x/fb/92/37/fb92376f8da272e02471f3303fc329ef.jpg" class="card-img rayon-img" alt="{{ $rayon->libelle }}">
                    <div class="card-img-overlay">
